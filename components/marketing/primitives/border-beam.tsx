...
// — copy-paste source component. Import path changed from "motion/react" to
// "framer-motion" (the package name this project has installed; same API,
// "motion" is just the newer rebrand of the same library).
